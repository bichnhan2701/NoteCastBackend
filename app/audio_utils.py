...
def to_wav_16k_mono(input_path: str, out_dir="/tmp") -> str:
    """
    ...
    # Allow ffmpeg output to surface in logs if error
...
def chunk_wav(wav_path: str, chunk_ms: int=30000, overlap_ms: int=1000, out_dir="/tmp") -> List[Tuple[str,int,int]]:
    """
